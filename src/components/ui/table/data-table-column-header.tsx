...
export function DataTableColumnHeader<TData, TValue>({
  ...
  if (!column.getCanSort() && !column.getCanHide()) {
    return (
      ...
      >
        {title}
        {column.getCanResize?.() && typeof column.getResizeHandler === 'function' && (
          <div
            onMouseDown={column.getResizeHandler('onMouseDown')}
            onTouchStart={column.getResizeHandler('onTouchStart')}
            style={{
              position: 'absolute',
              right: 0,
              top: 0,
